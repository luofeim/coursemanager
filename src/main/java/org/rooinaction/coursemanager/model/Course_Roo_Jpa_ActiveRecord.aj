...
privileged aspect Course_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Course.fieldNames4OrderClauseFilter = java.util.Arrays.asList("name", "description", "listPrice", "maximumCapacity", "runDate", "courseType");
