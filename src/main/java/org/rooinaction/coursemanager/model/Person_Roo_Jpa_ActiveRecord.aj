...
privileged aspect Person_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Person.fieldNames4OrderClauseFilter = java.util.Arrays.asList("firstName", "middleNameOrInitial", "addressLine1", "addressLine2", "city", "stateCode", "postalCode", "emailAddress");
